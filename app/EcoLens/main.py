...
from .routers import vehicle_usages
...
app.include_router(vehicle_usages.router)
...
#     tags=["VehicleUsage"],
# )
# async def read_by_id(id: str, response: Response, db: Session = Depends(get_db)):
#     new_item = (
...
#     tags=["VehicleUsage"],
# )
# async def delete(id: str, response: Response, db: Session = Depends(get_db)):
