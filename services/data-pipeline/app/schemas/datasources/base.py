...
# original success/failed/running/queued vocabulary — see `overview.md`
# §2: a run is "staged" once fetched and handed to RabbitMQ, and only
# "success" once `pipeline.warehouse_sync` actually lands it in Postgres.
RunStatus = Literal[
