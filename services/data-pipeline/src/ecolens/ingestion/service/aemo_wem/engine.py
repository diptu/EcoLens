...
Usage:
    ...
    async with httpx.AsyncClient(timeout=60) as client:
        ...
        duckdb_store.write_historical("aemo_wem", docs)
"""
...
from ecolens.ingestion.service.openelectricity import NETWORK_UTC_OFFSET_HOURS
from ecolens.shared.observability.logging import get_logger

from .client import AEMOWEMClient
from ecolens.ingestion.schema.aemo_wem import FACILITY_FUELTECH_MAP, OUTPUT_COLUMNS
