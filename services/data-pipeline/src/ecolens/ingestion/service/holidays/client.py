...
`ecolens.ingestion.core.circuit_breaker` module -- see ECO-101. The breaker
...
from ecolens.ingestion.core.circuit_breaker import CircuitBreaker, retry_with_backoff
