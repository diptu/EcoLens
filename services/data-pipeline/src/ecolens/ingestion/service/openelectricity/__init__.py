...
restructure):
  ecolens.ingestion.schema.openelectricity   configuration: FUEL_MAP, OUTPUT_COLUMNS, metric/network tables
  ecolens.ingestion.model.openelectricity    optional Pydantic models for stricter typing
...
`ecolens.ingestion.sources.openelectricity` package, from these new
locations.
...
from ecolens.ingestion.model.openelectricity import (
    OpenElectricityFacilityDoc,
    OpenElectricityMixDoc,
)
from ecolens.ingestion.schema.openelectricity import (
    CANONICAL_TO_RAW,
