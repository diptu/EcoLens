...
can respond. `/v1/readyz` checks the three things this service actually
needs: Postgres (`meta._ingest_log` writes), Redis (circuit-breaker
state, Phase 1), and RabbitMQ (publishing landed events, Phase 1) --
