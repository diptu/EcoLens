"""Request-ID propagation. Ported verbatim from `services/ingestion`'s
identical module (itself ported from `data-pipeline`) -- fully generic,
no warehouse-specific logic. See that module's own docstring for the
full "why" (a real `BaseHTTPMiddleware` exception-handling gap this
works around).
"""
